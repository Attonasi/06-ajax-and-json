...
Article.fetchAll = function() {
  if (localStorage.rawData) {
    ...
    var stuff = JSON.parse(localStorage.getItem('rawData'));
    Article.loadAll(stuff); //DONE: What do we pass in to loadAll()?
    ...
    $.getJSON('/data/hackerIpsum.json', function(monkey){

      var rawData = JSON.stringify(monkey);
      localStorage.setItem('rawData', rawData);

      Article.loadAll(monkey);
